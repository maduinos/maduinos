...
| `Codex_pet` | 개인 실험(비공개) | Codex CLI custom pet 자산과 설치·검증 도구를 비공개로 관리하고, 외부 배포 전 자산 사용 권리를 확인 |
...
- 표준 작업 폴더의 공개 및 비공개 GitHub 저장소가 생성되어 있습니다.
...
비즈니스 공개 자료를 먼저 푸시한 뒤 개인 실험 저장소(비공개 포함)를 푸시합니다.
...
git -C /home/maduinos/00_github_maduinos/Codex_pet push origin main
